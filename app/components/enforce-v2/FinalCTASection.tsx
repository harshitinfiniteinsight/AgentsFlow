...
export default function FinalCTASection() {
  return (
    <section className="bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.18),transparent_28%),linear-gradient(180deg,#081121_0%,#091120_100%)] py-6 lg:py-10">
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-2xl border border-white/10 bg-white/[0.05] px-8 py-10 text-center shadow-[0_30px_80px_rgba(15,23,42,0.35)] backdrop-blur-xl lg:px-12">
          <h2 className="mb-3 text-3xl font-bold text-white lg:text-4xl">
            Ready to Enforce AI Policies Everywhere?
          </h2>
          <p className="mx-auto mb-6 max-w-2xl text-base text-slate-400">
            Automatically translate governance policies into runtime controls across every AI platform, gateway, and cloud environment with AgentsFlow Enforce.
          </p>
